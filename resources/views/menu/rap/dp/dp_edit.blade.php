...
<div class="card">
    <div class="card-body">       
        ...
        <form method="POST" action="/rap/dp/{{$dp->id}}/update" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-xl-6 col-md-6 col-sm-12">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <select class="form-control" id="exampleFormControlSelect1" name="tempat_penampungan" >                    
                            <option selected >{{$dp->tempat_penampungan}} </option>
                ...
                <div class="col-xl-6 col-md-6 col-sm-12">
                        <div class="input-group mb-3">
                                ...
                                <input id="kamar" type="text" placeholder="Kamar" class="form-control" name="kamar" required autocomplete="kamar" value="{{$dp->kamar}}">                       
                            </div>         
                         <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input id="tanggal" type="date" value="{{$dp->tanggal}}" placeholder="Tangal" class="form-control" name="tanggal" required autocomplete="tanggal">                       
                    ...
                    <!-- <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <div class="input-file-container">  
                                <input class="input-file" name="barcode" id="my-file" type="file">
                                <label tabindex="0" for="my-file" class="input-file-trigger">Upload Barcode Pengungsi</label>
                            </div>
                        </div>                            
                    </div>             -->
                </div>
            ...
            <div class="row" >
                <div class="col">
                    <a href="{{route('dp')}}" class="btn btn-block btn-light">
                        Kembali
                    </a>                                        
                </div>
                <div class="col">
