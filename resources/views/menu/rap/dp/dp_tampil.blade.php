        ...
        <div class="row">
            ...
            <div class="col-xl-6  col-md-8">
                <dl class="row">
                    ...
                    <dt class="col-xl-5 col-md-4">Tahun Register </dt>
                    <dd class="col-xl-7  col-md-8">{{$dp->tahun_registrasi }} 
                    ...
                    <dt class="col-xl-5 col-md-4">Tempat Penampungan</dt>
                    <dd class="col-xl-7  col-md-8">{{$dp->tempat_penampungan}} </dd>
                    ...
                    <dd class="col-xl-7  col-md-8">{{$dp->created_at}} </dd>
            ...
            <div class="col-xl-3 col-md-12"> 
                ...
                <a href="/rap/dp/{{$dp->id}}/edit" style="width:100%;margin-top:10px" class="btn btn-warning">
                    Edit
                </a>                    
                @endif
                ...
                <!-- <a href="{{route('dp')}}" style="width:100%;margin-top:10px" class="btn btn-light">
                    Kembali
                </a>                                     -->
            </div>       
        </div> 
