    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-xl-3 col-md-5 col-sm-12 ">
                <h3 style="margin-bottom:20px"><b>Arsip Digital RAP</b> </h3>                       
            </div>            
            ...
            <?php $no = count($adrap);?>             
                ...
                <tr class="teks">
                    ...
                    <center>
                        ...
                        @if(auth()->user()->is_admin != 'tamu')               
                        <a href="/rap/adrap/{{$du->id}}/hapus" class="btn btn-brand btn-html5 btn-sm" style="margin:2px" onclick="return confirm('Apakah anda yakin ?')">
...
<div class="modal fade" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
    <form method="POST" action="{{route('store_foto_adrap')}}" enctype="multipart/form-data">
        @csrf                                  
