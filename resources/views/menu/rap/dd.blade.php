    ...
    <div class="card-body">
        <div class="row">
            <div class="col-xl-10 col-md-9 col-sm-12 ">
                <h3 style="margin-bottom:20px"><b>Tambah Data Deteni</b> </h3>                       
            </div>                       
        ...
        <div class="collapse" id="collapseExample">
            ...
            <form method="POST" action="{{ route('store_dd') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-xl-6 col-md-6 col-sm-12">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input id="nama_deteni" type="text" placeholder="Nama Deteni" class="form-control" name="nama_deteni" required autocomplete="nama_deteni">                       
                            </div>                      
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input id="no_identitas" type="text" placeholder="Nomor Identitas" class="form-control" name="no_identitas" required autocomplete="no_identitas" autofocus>                       
                            </div>     
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">
                        ...
                        <div class="col-xl-6 col-md-6 col-sm-12">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input id="kewarganegaraan" type="text" placeholder="Kewarganegaraan" class="form-control" name="kewarganegaraan" required autocomplete="kewarganegaraan" autofocus>                                                                        
                            </div>                         
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">
                                ...
                                <input id="asal_kiriman" type="text" placeholder="Asal Kiriman" class="form-control" name="asal_kiriman" required autocomplete="asal_kiriman" autofocus>                       
                            </div>                     
                            <div class="form-group">            
                                <label for="exampleFormControlTextarea1">Jenis Pelanggaran</label>
                                <textarea class="form-control" name="jenis_pelanggaran" id="exampleFormControlTextarea1" rows="4"></textarea>
                            </div>  
                        </div>
                    </div>             
    ...
    <div class="card-body">        
        <div class="row" style="margin-top:10px">
            <div class="col-xl-9 col-md-8 col-sm-12 ">
                <h3 style="margin-bottom:20px"><b>Rekapitulasi Data Deteni</b> </h3>                       
            </div>                       
            ...
            <!-- <div  class="col-xl-2 col-md-3 col-sm-12 ">      
                <a href="/rap/dd/export_excel_dd" class="btn btn-success btn-small" style="width:100%;margin-bottom:20px" target="_blank">Backup to Excel</a>            
            </div> -->
        </div>
        <table class="table table-hover table-responsive-md">
            <thead>
                <tr class="teks" >
                    ...
                    <th scope="col" style="width:15%">Nama Deteni
                    <th scope="col" style="width:13%">No. Identitas</th>
                    <th scope="col" style="width:5%">
                    <center>
                        L/P
                    </center> 
                    ...
                    <th scope="col" style="width:12%">Tgl. Masuk</th>
            ...
            <?php $no = count($dd);?>
                ...
                <tr class="teks" >
                    ...
                    <td>        
                        <center>                        
                            <a href="/rap/dd/{{$du->id}}/lihat" style="margin:1px" class="btn btn-brand btn-tumblr btn-sm">    
                                <i class="cui cui-user"></i>
                            </a>
                            @if(auth()->user()->is_admin != 'tamu')               
                        
                            <a href="/rap/dd/{{$du->id}}/edit"  style="margin:1px"class="btn btn-brand btn-twitter btn-sm">
                                <i class="cui cui-pencil"></i>
                            </a>
                        
                        
                            <a href="/rap/dd/{{$du->id}}/hapus"  style="margin:1px" class="btn btn-brand btn-html5 btn-sm" onclick="return confirm('Apakah anda yakin ?')">
