...
<div class="card">
    <div class="card-body">       
        <div class="row">
            <div class="col">
                <h3 style="margin-bottom:20px"><b>Edit Data Pengungsi</b></h3>                       
            </div>           
        </div>
        <form method="POST" action="/rap/dd/{{$dd->id}}/update" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-xl-6 col-md-6 col-sm-12">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input id="nama_deteni" type="text" value="{{$dd->nama_deteni}}"  placeholder="Nama Deteni" class="form-control" name="nama_deteni" required autocomplete="nama_deteni">                       
                    </div>                      
                    ...
                    <div class="input-group mb-3">
                        ...
                        <select class="form-control" id="exampleFormControlSelect1" name="tanggal" >                    
                            <option selected  >{{$dd->tanggal}}</option>
                        ...
                        <select class="form-control" id="exampleFormControlSelect1" name="bulan">       
                            <option selected  >{{$dd->bulan}}</option>             
                        ...
                        <select class="form-control" id="exampleFormControlSelect1" name="tahun">       
                            <option selected  >{{$dd->tahun}}</option>                                         
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input id="no_identitas" type="text" value="{{$dd->no_identitas}}"placeholder="Nomor Identitas" class="form-control" name="no_identitas" required autocomplete="no_identitas" autofocus>                      
                    </div>     
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text">
                        ...
                        <select class="form-control" id="exampleFormControlSelect1" name="jenis_kelamin" >                    
                            <option selected  >{{$dd->jenis_kelamin}}</option>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <select class="form-control" id="exampleFormControlSelect1" name="blok" >                    
                            <option selected  >{{$dd->blok}}</option>
                ...
                <div class="col-xl-6 col-md-6 col-sm-12">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input id="kewarganegaraan" type="text" value="{{$dd->kewarganegaraan}}" placeholder="Kewarganegaraan" class="form-control" name="kewarganegaraan" required autocomplete="kewarganegaraan" autofocus>                                                  
                    </div>                         
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text">
                        ...
                        <input id="asal_kiriman" type="text" value="{{$dd->asal_kiriman}}" placeholder="Asal Kiriman" class="form-control" name="asal_kiriman" required autocomplete="asal_kiriman" autofocus>                       
                    </div>                     
                    <div class="form-group">            
                        <label for="exampleFormControlTextarea1">Jenis Pelanggaran</label>
                        <textarea class="form-control" name="jenis_pelanggaran" id="exampleFormControlTextarea1" rows="4">{{$dd->jenis_pelanggaran}}</textarea>
                    </div>  
                </div>
            </div>             
            ...
            <div class="row" >
                <div class="col">
                    <a href="{{route('dd')}}" class="btn btn-block btn-light">
                        Kembali
                    </a>                                        
                </div>
                <div class="col">
