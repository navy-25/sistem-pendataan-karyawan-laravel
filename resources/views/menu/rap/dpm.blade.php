    ...
    <div class="card-body">
        <div class="row">
            <div class="col-xl-10 col-md-9 col-sm-12 ">
                <h3 style="margin-bottom:20px"><b>Tambah Data Pengungsi Mandiri</b> </h3>                       
            </div>                       
        ...
        <div class="collapse" id="collapseExample">
            <div class="card card-body">
                <form method="POST" action="{{ route('store_dpm') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-md-6 col-sm-12">
                            <div class="input-group mb-3">
                                ...
                                <input id="alamat" type="text" placeholder="Alamat Lengkap" class="form-control" name="alamat" required autocomplete="alamat">                       
                            </div>                 
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select class="form-control" id="exampleFormControlSelect1" name="kewarganegaraan">         
                                    <option>Afganistan</option><option>Iran</option><option>Irak</option>
                                    <option>Suriah</option><option>Palestina</option><option>Myanmar</option>
                                    <option>Eritrea</option><option>Sudan</option><option>Pakistan</option>
                                    <option>Srilanka</option><option>Somalia</option>
    ...
    <div class="card-body">        
        <div class="row" style="margin-top:10px">
            <div class="col-xl-7 col-md-6 col-sm-12 ">
                <h3 style="margin-bottom:20px"><b>Rekapitulasi Data Pengungsi Mandiri</b> </h3>                       
            </div>                       
            ...
            <div  class="col-xl-2 col-md-3 col-sm-12 ">      
                <a href="{{route('export_excel_dpm')}}" class="btn btn-success btn-small" style="width:100%;margin-bottom:20px" target="_blank">Rekab</a>            
            </div>
        </div>
        <table class="table table-hover table-striped table-responsive-md">
            ...
            <?php $no = count($dp);?>
                ...
                <tr class="teks" >
                    ...
                    <td>                
                        <center>                        
                            <a href="/rap/dpm/{{$du->id}}/lihat" style="margin:1px" class="btn btn-brand btn-tumblr btn-sm">    
                                <i class="cui cui-user"></i>
                            </a>
                            @if(auth()->user()->is_admin != 'tamu')  
                            <a href="/rap/dpm/{{$du->id}}/cetak_pdf" target="_blank"  style="margin:1px"class="btn btn-brand btn-spotify btn-sm">
                                <i class="cui cui-featured-playlist"></i>
                            </a>             
                            <a href="/rap/dpm/{{$du->id}}/edit"  style="margin:1px"class="btn btn-brand btn-twitter btn-sm">
                                <i class="cui cui-pencil"></i>
                            </a>
                            <a href="/rap/dpm/{{$du->id}}/hapus"  style="margin:1px" class="btn btn-brand btn-html5 btn-sm" onclick="return confirm('Apakah anda yakin ?')">
