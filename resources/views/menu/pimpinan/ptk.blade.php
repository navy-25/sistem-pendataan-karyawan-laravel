    ...
    <div class="card-body">
        <div class="row">
            <div class="col-xl-10 col-md-9 col-sm-12 ">
                <h3 style="margin-bottom:20px"><b>Buat Laporan Protokoler</b> </h3>                       
            </div>                       
        ...
        <div class="collapse" id="collapseExample">
            <div class="card card-body">
                <form method="POST" action="{{ route('store_ptk') }}">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-md-6 col-sm-12">
                            <div class="input-group mb-3">
                                ...
                                <input id="penanggung_jawab" type="text" placeholder="Penanggung Jawab" class="form-control" name="penanggung_jawab" required autocomplete="penanggung_jawab">                       
                            </div>    
                            <div class="form-group">            
                                <label for="exampleFormControlTextarea1">Persiapan</label>
                                <textarea class="form-control" name="persiapan" id="exampleFormControlTextarea1" rows="2"></textarea>
                            </div>                                
                        </div>
                    </div>                         
        ...
        <table class="table table-hover  table-striped table-responsive-md">
            ...
            <?php $no = count($ptk);?>
                ...
                <tr class="teks" >
                    ...
                    <td>                
                    <center>                
                        <a href="/pimpinan/ptk/{{$du->id}}/lihat" style="margin:2px" class="btn btn-brand btn-tumblr btn-sm">
                            <i class="cui cui-user"></i>
                        </a>
                        @if(auth()->user()->is_admin != 'tamu')               
                        <a href="/pimpinan/ptk/{{$du->id}}/edit"  style="margin:2px" class="btn btn-brand btn-twitter btn-sm">
                            <i class="cui cui-pencil"></i>
                        </a>
                        <a href="/pimpinan/ptk/{{$du->id}}/hapus" style="margin:2px"  class="btn btn-brand btn-html5 btn-sm" onclick="return confirm('Apakah anda yakin ?')">
