...
<div class="card">
    <div class="card-body">       
        <div class="row">
            <div class="col">
                <h3 style="margin-bottom:20px"><b>Edit Kebutuhan Deteni</b></h3>                       
            </div>           
        </div>
        <form method="POST" action="/pimpinan/tk/{{$tk->id}}/update">
            @csrf
            <div class="row">
                <div class="col-xl-6 col-md-6 col-sm-12">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <select class="form-control" id="exampleFormControlSelect1" name="tanggal" >                    
                            <option selected>{{$tk->tanggal}}</option>
                        ...
                        <select class="form-control" id="exampleFormControlSelect1" name="bulan">       
                            <option selected >{{$tk->bulan}}</option>             
                        ...
                        <select class="form-control" id="exampleFormControlSelect1" name="tahun">       
                            <option selected >{{$tk->tahun}}</option>                                         
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input id="nama_kegiatan" type="text" value="{{$tk->nama_kegiatan}}" placeholder="Nama Kegiatan " class="form-control" name="nama_kegiatan" required autocomplete="nama_kegiatan">                       
                    </div>    
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text">
                        ...
                        <input id="tempat" type="text" placeholder="Tempat Pelaksanaan" value="{{$tk->tempat}}" class="form-control" name="tempat" required autocomplete="tempat">                       
                    </div>    
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text">
                        ...
                        <select class="form-control" id="exampleFormControlSelect1" name="status" >                    
                            <option selected >{{$tk->status}}</option>
                ...
                <div class="col-xl-6 col-md-6 col-sm-12">
                    <div class="form-group">            
                        ...
                        <textarea class="form-control" name="konsep" id="exampleFormControlTextarea1" rows="2">{{$tk->konsep}}</textarea>
                    </div>    
                    <div class="form-group">            
                        <label for="exampleFormControlTextarea1">Dasar</label>
                        <textarea class="form-control" name="dasar" id="exampleFormControlTextarea1" rows="1">{{$tk->dasar}}</textarea>
                    </div>     
                </div>
            </div>                         
