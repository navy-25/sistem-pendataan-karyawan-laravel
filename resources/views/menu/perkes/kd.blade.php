    ...
    <div class="card-body">
        <div class="row">
            <div class="col-xl-10 col-md-9 col-sm-12 ">
                <h3 style="margin-bottom:20px"><b>Buat Data Kebutuhan Deteni</b> </h3>                       
            </div>                       
        ...
        <div class="collapse" id="collapseExample">
            <div class="card card-body">
                <form method="POST" action="{{ route('store_kd') }}">
                    @csrf
                    <div class="row">
                        <div class="col-xl-6 col-md-6 col-sm-12">                           
                            <div class="input-group mb-3">
                                ...
                                <input id="nama_penerima" type="text" placeholder="Nama Penerima" class="form-control" name="nama_penerima" required autocomplete="nama_penerima" autofocus>                       
                            </div>                                              
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">
    ...
    <div class="card-body">        
        <div class="row" style="margin-top:10px">
            <div class="col-xl-7 col-md-6 col-sm-12 ">
                <h3 style="margin-bottom:20px"><b>Rekapitulasi Kebutuhan Deteni</b> </h3>                       
            </div>                       
            <form class="col-xl-3 col-md-3  col-sm-12">
                <input type="text"  style="margin-bottom:20px" name="cari"  class="form-control" placeholder="Cari Nama Penerima"> <a class="srh-btn"><i class="ti-search"></i></a>
            </form>
            <div  class="col-xl-2 col-md-3 col-sm-12 ">      
                <a href="{{route('export_excel_kd')}}" class="btn btn-success btn-small" style="width:100%;margin-bottom:20px" target="_blank">Rekab</a>            
            </div>
        </div>
        <table class="table table-hover table-striped table-responsive-md">
            <thead>
                ...
                <th scope="col" style="width:5%">
                    ...
                    <th scope="col" style="width:25%">Nama Penerima</th>
                    <th scope="col" style="width:20%">Tanggal Lapor</th>
                    <th scope="col" style="width:15%">Jenis Kebutuhan</th>
            ...
            ?>               
                ...
                <tr class="teks">
                    ...
                    <td>{{$du->nama_penerima}}</td>
                    <td>{{$du->tanggal}}/{{$du->bulan}}/{{$du->tahun}}</td>
                    <td>{{$du->jenis_kebutuhan}}</td>
                    <td>{{$du->created_at}}</td>
                    <td>                
                    <center>                
                        <a href="/perkes/kd/{{$du->id}}/lihat" style="margin:2px" class="btn btn-brand btn-tumblr btn-sm">
                            <i class="cui cui-user"></i>
                        </a>
                        @if(auth()->user()->is_admin != 'tamu')               
                        <a href="/perkes/kd/{{$du->id}}/edit"  style="margin:2px" class="btn btn-brand btn-twitter btn-sm">
                            <i class="cui cui-pencil"></i>
                        </a>
                        <a href="/perkes/kd/{{$du->id}}/hapus" style="margin:2px"  class="btn btn-brand btn-html5 btn-sm" onclick="return confirm('Apakah anda yakin ?')">
